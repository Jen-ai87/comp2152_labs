...
if not input_invalid:
    ...
    print("    |", end="    ")
    print("------------------------------------------------------------------")
    # Once valid input is received, adjust combat strength based on the previous game
    combat_strength, m_combat_strength = functions_lab06.adjust_combat_strength(combat_strength, m_combat_strength)
    print("    |", end="    ")
    print(f"\033[32mHero Strength: {combat_strength}, Monster Strength: {m_combat_strength}\033[0m")
    print("    |", end="    ")
    print("------------------------------------------------------------------")
    # Roll for weapon
    print("    |", end="    ")
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    print("    |", end="    ")
    # Method added to functions file to validate and ask level
    num_dream_lvls = functions_lab06.get_valid_dream_levels()
    if num_dream_lvls != 0:
        health_points -= 1
    ...
    hero_wins = combat_strength > m_combat_strength

    if hero_wins:
        num_stars = random.randint(1, 5)
        print(f"Hero {short_name} has killed the monster and gained {num_stars} stars.")
        functions_lab06.save_game("hero", short_name, num_stars)
    else:
        print("Monster has killed the hero previously.")
        functions_lab06.save_game("monster")
